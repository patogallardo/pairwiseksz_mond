...
plt.savefig('plots/contour_plot_normal_prefactor.pdf')
plt.close()
#################### End n-amp plot
...
# plot prefactor dependence
n = np.linspace(0.5, 4, 100);
plt.semilogy(n, prefactor**(n/2)); 
plt.xlabel("n")
plt.ylabel("$\\frac{4\\pi G \\rho_b}{c \\sqrt{G \\rho_c}}$")
plt.savefig("./plots/diagnostic_prefactor_n_dependence.pdf")
plt.close()